...
export default function Project({
  ...
  return (
    ...
    >
      <section className=" relative bg-gray-100 rounded-lg max-w-[42rem] borderBlack/5 overflow-hidden sm:pr-8 sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:bg-white/10 dark:hover:bg-white/20 dark:text-white">
